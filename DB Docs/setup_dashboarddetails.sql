...
LOCK TABLES `dashboarddetails` WRITE;
/*!40000 ALTER TABLE `dashboarddetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `dashboarddetails` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-01-12 15:00:55
